...
parameter BASE_RAM_INIT_FILE = "C:/Users/guodl/Desktop/nscscc2022_single_v1/kernel/kernel.bin"; //BaseRAM初始化文件，请修改为实际的绝对路径
parameter EXT_RAM_INIT_FILE = "/tmp/eram.bin";    //ExtRAM初始化文件，请修改为实际的绝对路径
parameter FLASH_INIT_FILE = "C:/Users/guodl/Desktop/nscscc2022_single_v1/kernel/kernel.elf";    //Flash初始化文件，请修改为实际的绝对路径

wire cpu_data_avai;
assign cpu_data_avai = thinpad_top.cpu_data_avai;

wire [31:0] cpu_data_addr;
assign cpu_data_addr = thinpad_top.cpu_data_addr;
wire inst_sb;
assign inst_sb = MEM.inst_sb;
wire inst_Lb;
assign inst_Lb = MEM.inst_lb;
wire [31:0] wb_result;
assign wb_result = MEM.wb_result;
wire [7:0] lb_low_data;
assign lb_low_data = MEM.lb_low_data;
wire [3:0] mem_OneHot;
assign mem_OneHot = EX.mem_OneHot;
wire [3:0] sb_lb_decoder;
assign sb_lb_decoder = MEM.sb_lb_decoder;
wire [31:0] cpu_data_wdata;
assign cpu_data_wdata = thinpad_top.cpu_data_wdata;
wire [7:0] ext_uart_tx;
assign ext_uart_tx =thinpad_top.ext_uart_tx;
initial begin  
    //在这里可以自定义测试输入序列，例如：
    dip_sw = 32'h2;
    touch_btn = 0;
